...
const Card = ({imgURL, title, description}) => {
  return (
    <div className="mt-2 group absolute top-[12%] left-[50%] translate-x-[-50%] h-[18rem] w-[14rem] rounded-md bg-[rgba(41,40,40,0.42)] shadow-lg hover:bg-[rgba(75,73,73,0.42)] cursor-pointer transition-all duration-200 p-4">
      <img
